...
const FlickeringGrid: React.FC<FlickeringGridProps> = ({
    ...
    const setupCanvas = useCallback(
        (canvas: HTMLCanvasElement) => {
            // Use visualViewport height if available, fallback to window.innerHeight
            const viewportHeight = window.visualViewport?.height || window.innerHeight
            const canvasWidth = width || canvas.clientWidth
            const canvasHeight = height || viewportHeight
    ...
    useEffect(() => {
        ...
        // Add event listeners for both resize and visualViewport
